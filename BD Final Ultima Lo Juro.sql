...
INSERT INTO productos(codigo_sucursal, id_producto, categoria, producto, precio, stock_actual, stock_minimo, stock_maximo) VALUES
...
INSERT INTO facturas (letra, nro_pedido, fecha, id_producto, id_cliente, id_sucursal, forma_de_pago) VALUES
    ...
    ('C', 6, '2023-11-06', 6, 6, 1, 'efectivo'),
    ('A', 7, '2023-01-01', 7, 7, 2, 'tarjeta'),
    ('B', 8, '2023-09-10', 8, 8, 3, 'efectivo'),
    ('B', 9, '2023-08-09', 9, 9, 4, 'tarjeta'),
    ('C', 10, '2023-03-25', 10, 10, 5, 'efectivo'),
    ('C', 11, '2023-07-30', 11, 11, 1, 'tarjeta'),
    ('A', 12, '2023-04-02', 12, 12, 2, 'tarjeta'),
    ('C', 13, '2023-01-13', 13, 13, 3, 'efectivo'),
    ('A', 14, '2023-12-14', 14, 14, 4, 'tarjeta'),
    ('B', 15, '2023-12-14', 15, 15, 5, 'efectivo');
    
select * from facturas;

-- pequeña anomalía: la pk de sucursales es autoincrementable,
-- idealmente debería detenerse en la cantidad fija de sucursales que quiera ponerle, pero
-- al testear los insert en facturas la pk de sucursales se incrementa hasta la cantidad de facturas emitidas
-- también, al comentar el AUTO_INCREMENT UNIQUE KEY en el campo  id_sucursal INT de la tabla Sucursales
-- sigue existiendo la misma anomalía 

-- Al final era un error con los insert, sorry